...
public class VNPayConfig {
    ...
    public Map<String, String> getVNPayConfig(String preorderId, String username, Integer transactionId) {
        ...
        vnpParamsMap.put("vnp_ReturnUrl", this.vnpReturnUrl + "?preorderId=" + preorderId + "&username=" + username + "&transactionId=" + transactionId);
